...
class Solution2 {
    constructor() {
        ...
        this.cubeBackId = 'CB';
        this.cubeFrontId = 'CF';
        this.cubeBottomId = 'CB';
        this.cubeInfo = new Map()
        this.currentLoc = { x: 0, y: 0, facing: this.right, cubeSide: this.cubeTop };
        this.right = 0;
        this.down = 1;
        this.left = 2
        this.up = 3;
        ...
        this.cubeTop = {yStart: 0, yEnd: 49, xStart: 50, xEnd: 99};
        this.cubeRight = {yStart: 0, yEnd: 49, xStart: 100, xEnd: 149};
        this.cubeFront = {yStart: 50, yEnd: 99, xStart: 50, xEnd: 99};
        this.cubeBottom = {yStart: 50, yEnd: 99, xStart: 50, xEnd: 99};
        this.cubeLeft = {yStart: 100, yEnd: 149, xStart: 0, xEnd: 49};
        this.cubeBack = {yStart: 150, yEnd: 199, xStart: 0, xEnd: 49};
    }
    ...
    initCubeInfo(){
        this.cubeInfo.set(this.cubeTopId, this.cubeTop);
        this.cubeInfo.set(this.cubeBottomId, this.cubeBottom);
        this.cubeInfo.set(this.cubeRightId, this.cubeRight);
        this.cubeInfo.set(this.cubeLeftId, this.cubeLeft);
        this.cubeInfo.set(this.cubeBackId, this.cubeBack);
        this.cubeInfo.set(this.cubeFrontId, this.cubeFront);
    }
